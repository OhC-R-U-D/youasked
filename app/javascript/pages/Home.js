  ...
  render() {
    return (
      <div id="body-container">
        ...
        <div id="quote">
          <p>
            Sometimes life isn’t black and white and we’re faced with questions,
            but let’s keep it light! Post your questions if you have one now…
            but responses may be below the brow.
          </p>
        </div>
      </div>
    );
